...
Queue which automatically remove old elements. I used this data structure in [SkyEye](https://github.com/dharmab/skyeye) for trackfiles (think the little moving dots representing airplanes on an air traffic controller's radar).
